...
import {
  ...
  options6,
  options7
} from "./options/listWidgetChartOptions";
...
export default function ListWidget() {
  ...
  const handlePageClick = (data) => {
    ...
    setState((prevState) => ({ ...prevState, dataTablePage: pageNumber }));
  };

  const getList1 = (arr) => {
    return arr.map((id) => (
      <div key={id} className={clsx({ "ul-widget1": true, "mt-3": id === 1 })}>
        ...
        <div className="ul-widget-notification-item-div">
          <Link to="/" className="ul-widget-notification-item">
            ...
            <div className="ul-widget-notification-item-details">
              <div className="ul-widget-notification-item-title">{data[ind].title}</div>
              <div className="ul-widget-notification-item-time">{data[ind].time}</div>
            </div>
          </Link>
        </div>
      </div>
        ...
        {arr.map((user, ind) => (
          <div key={ind} className="ul-widget4__item  ul-widget4__users">
            ...
            <div className="ul-widget4__actions">
              <button type="button" className={`btn btn-outline-${data[ind].color} m-1`}>
                Follow
              </button>
            </div>
          </div>
  ...
  let { tableData, dataTablePage, dataTablePerPage } = state;

  return (
    <div>
      <Breadcrumb routeSegments={[{ name: "Widgets", path: "/widgets" }, { name: "List" }]} />
      ...
      <Row>
              ...
              <div className="ul-widget1">
                <div className="ul-widget__item">
                  <div className="ul-widget__info">
                    ...
                    <span className="ul-widget__desc text-mute">Average Weekly Profit</span>
                  </div>
                  <span className="ul-widget__number text-primary">+$17,800</span>
                </div>

                <div className="ul-widget__item">
                  <div className="ul-widget__info">
                    <h3 className="ul-widget1__title">Orders</h3>
                    <span className="ul-widget__desc text-mute">Weekly Customer Orders</span>
                  </div>
                  <span className="ul-widget__number text-danger">+1,800</span>
                </div>

                <div className="ul-widget__item">
                  <div className="ul-widget__info">
                    <h3 className="ul-widget1__title">Issue Reports</h3>
                    <span className="ul-widget__desc text-mute">System bugs and issues</span>
                  </div>
                  <span className="ul-widget__number text-success">-27,49%</span>
                </div>
              </div>
            </Card.Body>
          </Card>
            ...
            <div className="ul-widget1">
              <div className="ul-widget__item">
                <div className="ul-widget__info">
                  ...
                  <span className="ul-widget__desc text-mute">Average IPO Margin</span>
                </div>
              ...
              <div className="ul-widget__item">
                <div className="ul-widget__info">
                  ...
                  <span className="ul-widget__desc text-mute">Yearly Expenses</span>
                </div>
                <span className="ul-widget__number text-danger">+$560,800</span>
              </div>
              <div className="ul-widget__item">
                <div className="ul-widget__info">
                  <h3 className="ul-widget1__title">Issue Reports</h3>
                  <span className="ul-widget__desc text-mute">Overall Regional Logistics</span>
                </div>
            ...
            <div className="ul-widget1">
              <div className="ul-widget__item">
                <div className="ul-widget__info">
                  ...
                  <span className="ul-widget__desc text-mute">Daily Transaction Increase</span>
                </div>
              ...
              <div className="ul-widget__item">
                <div className="ul-widget__info">
                  <h3 className="ul-widget1__title">Orders</h3>
                  <span className="ul-widget__desc text-mute">Average Weekly Orders</span>
                </div>
              ...
              <div className="ul-widget__item">
                <div className="ul-widget__info">
                  ...
                  <span className="ul-widget__desc text-mute">Overall Revenue Increase</span>
                </div>
          ...
          <Card body className="h-100">
            <div className="ul-widget__head pb-20 v-margin">
              ...
              <Dropdown>
                ...
                <Dropdown.Menu>
                  <Link to="/" className="dropdown-item ul-widget__link--font">
                    <i className="i-Bar-Chart-4" />
                    Export
                  </Link>

                  <Link to="/" className="dropdown-item ul-widget__link--font">
                    <i className="i-Data-Save" />
                    Save
                  </Link>

                  <Link to="/" className="dropdown-item ul-widget__link--font">
                    <i className="i-Duplicate-Layer" />
                    Import
                  </Link>
                  ...
                  <Link to="/" className="dropdown-item ul-widget__link--font">
                    <i className="i-Folder-Download" />
                    Update
                  </Link>

                  <Link to="/" className="dropdown-item ul-widget__link--font">
                    <i className="i-Gears-2" />
                    Customize
                  </Link>
                </Dropdown.Menu>
              </Dropdown>
              ...
              <div className="ul-widget1">
                {state.userList.map((user, ind) => (
                  <div key={ind} className="ul-widget4__item ul-widget4__users">
                    ...
                    <span className={`ul-widget4__number t-font-boldest text-${user.color}`}>
                      +{user.amount}
                    </span>
                  </div>
                ))}
              ...
              <div className="__g-widget4">
                <div className="ul-widget4__item">
                  <div className="ul-widget4__pic-icon">
                    <i className="i-File-Clipboard-File--Text text-success" />
                  </div>
                ...
                <div className="ul-widget4__item">
                  <div className="ul-widget4__pic-icon">
                    <i className="i-File-CSV text-success" />
                  </div>
                  <Link to="/" className="ul-widget4__title">
                ...
                <div className="ul-widget4__item">
                  <div className="ul-widget4__pic-icon">
                    <i className="i-File-Zip text-danger" />
                  </div>
                  <Link to="/" className="ul-widget4__title">
                ...
                <div className="ul-widget4__item">
                  <div className="ul-widget4__pic-icon">
                    <i className="i-File-JPG text-warning" />
                  </div>
                  <Link to="/" className="ul-widget4__title">
            ...
            <div className="ul-widget__body">
              <div className="ul-widget1">
                <div className="ul-widget4__item ul-widget4__users">
                  <div className="ul-widget4__pic-icon">
                    <i className="i-Folder-Download text-info" />
                  </div>
                  ...
                  <span className="ul-widget4__number t-font-boldest text-success">+500</span>
                </div>

                <div className="ul-widget4__item ul-widget4__users">
                  <div className="ul-widget4__pic-icon">
                    <i className="i-File-Cloud text-success" />
                  </div>
                  ...
                  <span className="ul-widget4__number t-font-boldest text-info">+500</span>
                </div>

                <div className="ul-widget4__item ul-widget4__users">
                  <div className="ul-widget4__pic-icon">
                    <i className="i-File-Clipboard-Text--Image text-danger" />
                  </div>
                  ...
                  <span className="ul-widget4__number t-font-boldest text-warning">+333</span>
                </div>

                <div className="ul-widget4__item ul-widget4__users">
                  <div className="ul-widget4__pic-icon">
                    <i className="i-Folder-Download text-warning" />
                  </div>
                  ...
                  <span className="ul-widget4__number t-font-boldest text-danger">+200</span>
                </div>
              </div>
            </div>
          </Card>
        ...
        <Col sm={8} xs={12} className="mb-4">
          <Card body className="h-100">
            ...
            <div className="ul-widget__body">
              <Tabs className="justify-content-end" defaultActiveKey="Latest" id="notification">
                    ...
                    <div className="ul-widget5__item ">
                      ...
                      <div className="ul-widget5__content">
                        <div className="ul-widget5__stats">
                          ...
                          <span className="ul-widget5__sales text-mute">sales</span>
                        </div>
                        <div className="ul-widget5__stats">
                          <span className="ul-widget5__number">1046</span>
                          <span className="ul-widget5__sales text-mute">votes</span>
                        </div>
                      </div>
                    </div>
              ...
              <div className="ul-widget3">
                  ...
                  <div className="ul-widget3-header">
                    ...
                    <div className="ul-widget3-info">
                      <Link to="/" className="__g-widget-username">
                        <span className="t-font-bolder">Timithy Clarkson</span>
                      </Link>
                      <br />
                      <span className="ul-widget-notification-item-time">2 hrs ago</span>
                    </div>
                    <span className="ul-widget3-status text-success t-font-bolder">Pending</span>
                  </div>
                ...
                <div className="ul-widget3-item">
                  <div className="ul-widget3-header">
                    ...
                    <div className="ul-widget3-info">
                      <Link to="/" className="__g-widget-username">
                        <span className="t-font-bolder">Jannet Clarkson</span>
                      </Link>
                      <br />
                      <span className="ul-widget-notification-item-time">12 hrs ago</span>
                    </div>
                    <span className="ul-widget3-status text-danger t-font-bolder">Decline</span>
                  </div>
                  <div className="ul-widget3-body">
                    <p className="ul-widget3-text text-mute">
                      Lorem ipsum dolor sit amet,consectetuer edipiscing elit,sed diam nonummy nibh
                ...
                <div className="ul-widget3-item">
                  <div className="ul-widget3-header">
                    ...
                    <div className="ul-widget3-info">
                      ...
                      <br />
                      <span className="ul-widget-notification-item-time">Today</span>
                    </div>
                    <span className="ul-widget3-status text-warning t-font-bolder">Processing</span>
                  </div>
                  <div className="ul-widget3-body">
                    <p className="ul-widget3-text text-mute">
                      Lorem ipsum dolor sit amet,consectetuer edipiscing elit,sed diam nonummy nibh
              ...
              <div className="ul-widget6">
                ...
                <div className="ul-widget6__body">
                  <div className="ul-widget6__item">
                    <span>16/13/17</span>
                    <span>67</span>
                    <span className="t-font-boldest text-success">$14,740</span>
                  </div>

                  <div className="ul-widget6__item">
                    <span>02/28/17</span>
                    <span>120</span>
                    <span className="t-font-boldest text-danger">$14,740</span>
                  </div>

                  <div className="ul-widget6__item">
                    <span>02/28/17</span>
                    <span>120</span>
                    <span className="t-font-boldest text-warning">$14,740</span>
                  </div>

                  <div className="ul-widget6__item">
                    <span>02/28/17</span>
                    <span>120</span>
                    <span className="t-font-boldest text-primary">$14,740</span>
                  </div>

                  <div className="ul-widget6__item">
                    <span>02/28/17</span>
                    <span>120</span>
                    <span className="t-font-boldest text-dark">$14,740</span>
                  </div>
                </div>
                    ...
                    <div className="ul-widget-s5__item mb-5">
                      <div className="ul-widget-s5__content">
                        ...
                        <div className="ul-widget-s5__section">
                          ...
                          <p className="ul-widget-s5__desc">UI LIb admin themes.</p>
                        </div>
                      </div>
                      <div className="ul-widget-s5__content">
                        <div className="ul-widget-s5__progress">
                          ...
                          <ProgressBar now={50} striped variant="success"></ProgressBar>
                        </div>
                    ...
                    <div className="ul-widget-s5__item mb-5">
                      ...
                      <div className="ul-widget-s5__content">
                        <div className="ul-widget-s5__progress">
                          ...
                          <ProgressBar now={75} striped variant="danger"></ProgressBar>
                        </div>
                    ...
                    <div className="ul-widget-s5__item mb-5">
                      ...
                      <div className="ul-widget-s5__content">
                        <div className="ul-widget-s5__progress">
                          ...
                          <ProgressBar now={35} striped variant="warning"></ProgressBar>
                        </div>
        ...
        <Col sm={8} xs={12} className="mb-4">
          <Card body>
            <div className="ul-widget__head border-0 mb-2">
              <div className="ul-widget__head-label">
                <h3 className="ul-widget__head-title">Exclusive data table plugin</h3>
              </div>
              <Dropdown>
                <Dropdown.Toggle as="span" className="toggle-hidden cursor-pointer">
                  <span className="_dot _inline-dot bg-primary mr-1"></span>
              ...
              <div className="ul-widget3">
                      ...
                      {tableData
                        ...
                        .map((user, ind) => (
                          <tr key={ind}>
                            ...
                            <td>
                              <span>
                                <div className="ul-widget_user-card">
                                  <div className="ul-widget4__img">
                                    <img src={user.imgUrl} id="userDropdown" alt="" />
                                  </div>
                                </div>
                              </span>
                            </td>
                            ...
                            <td>
                              <Link to="/" className="ul-widget4__title d-block">
                                UI Lib
                              </Link>
                ...
                <nav aria-label="Page navigation example">
                  <ReactPaginate
                    ...
                    pageCount={Math.ceil(tableData.length / dataTablePerPage)}
        ...
        <Col sm={4} xs={12} className="mb-4">
          <Card body className="h-100">
            <Card.Title>Latest Log</Card.Title>
            <div className="ul-widget__body">
              <Tabs className="justify-content-end" defaultActiveKey="Latest" id="notification">
                <Tab eventKey="Latest" title="Latest">
                  <div className="ul-widget-s6__items">
                    <div className="ul-widget-s6__item">
                      ...
                      <span className="ul-widget-s6__text">12 new users registered</span>
                    ...
                    <div className="ul-widget-s6__item">
                      ...
                      <p className="ul-widget-s6__text">
                        System shutdown
                        <span className="badge badge-pill badge-primary  m-2">Primary</span>
                      </p>
                    ...
                    <div className="ul-widget-s6__item">
                      ...
                      <p className="ul-widget-s6__text">
                        System shutdown
                        <span className="badge badge-pill badge-success  m-2">Primary</span>
                      </p>
                      <span className="ul-widget-s6__time">14 mins</span>
                    </div>
                    ...
                    <div className="ul-widget-s6__item">
                      ...
                      <p className="ul-widget-s6__text">
                        System shutdown
                        <span className="badge badge-pill badge-danger  m-2">Primary</span>
                      </p>
                      <span className="ul-widget-s6__time">14 mins</span>
                    </div>
                  </div>
                  ...
                  <div className="ul-widget2">
                    <div className="ul-widget-s6__items">
                      <div className="ul-widget-s6__item">
                        ...
                        <span className="ul-widget-s6__text">44 new users registered</span>
                        <span className="ul-widget-s6__time">Just Now</span>
                      </div>
                      <div className="ul-widget-s6__item">
                        <span className="ul-widget-s6__badge">
        ...
        <Col sm={6} xs={12} className="mb-4">
          <Card body className="h-100">
            <div className="ul-widget__head __g-support v-margin">
              ...
              <Dropdown>
                <Dropdown.Toggle as="span" className="toggle-hidden cursor-pointer">
                  <span className="_dot _inline-dot bg-primary me-1" />
                  <span className="_dot _inline-dot bg-primary me-1" />
          ...
          <Card body>
            ...
            <Tabs className="justify-content-end" defaultActiveKey="Latest" id="notification">
              <Tab eventKey="Latest" title="Latest">
                <div className="ul-widget-s7n">
                  <div className="ul-widget-s7__items mb-4">
                    <span className="ul-widget-s7__item-time ul-middle">10:00</span>
                    <div className="ul-widget-s7__item-circle">
                  ...
                  <div className="ul-widget-s7__items mb-4">
                    <span className="ul-widget-s7__item-time ul-middle">08:00</span>
                    <div className="ul-widget-s7__item-circle">
                  ...
                  <div className="ul-widget-s7__items mb-4">
                    <span className="ul-widget-s7__item-time ul-middle">13:00</span>
                    <div className="ul-widget-s7__item-circle">
                  ...
                  <div className="ul-widget-s7__items">
                    <span className="ul-widget-s7__item-time ul-middle">05:30</span>
                    <div className="ul-widget-s7__item-circle">
              ...
              <Tab className="ul-widget__body" eventKey="Month" title="Month">
                <div className="ul-widget-s7n">
                  <div className="ul-widget-s7__items mb-4">
                    <span className="ul-widget-s7__item-time ul-middle">12:00</span>
                    <div className="ul-widget-s7__item-circle">
                      <p className="ul-vertical-line bg-danger "></p>
                    </div>
                    <div className="ul-widget-s7__item-text">
                  ...
                  <div className="ul-widget-s7__items mb-4">
                    <span className="ul-widget-s7__item-time ul-middle">04:30</span>
                    <div className="ul-widget-s7__item-circle">
                      <p className="ul-vertical-line bg-warning "></p>
                    </div>
                    <div className="ul-widget-s7__item-text">
            ...
            <Table responsive>
              ...
              <tbody>
                <tr>
                  <th scope="row">666</th>
                  <td>
                    <span className="text-15 font-weight-200">Dan brown on the North</span>
                    <br />
                  </td>
                  <td>
                    <span className="badge badge-primary w-badge">Developing</span>
                  </td>
                  <td>
                    <Chart
                      options={options1}
                ...
                <tr>
                  ...
                  <td>
                    <span className="badge badge-danger w-badge">Backend</span>
                  </td>
                  <td>
                    <Chart
                      options={options2}
                ...
                <tr>
                  ...
                  <td>
                    <span className="badge badge-success w-badge">Frontend</span>
                  </td>
                  <td>
                    <Chart
                      options={options3}
                ...
                <tr>
                  ...
                  <td>
                    <span className="text-15 font-weight-200">Jaret Leto</span>
                    <br />
                  </td>
                  <td>
                    <span className="badge badge-warning w-badge">Backend</span>
                  </td>
                  <td>
                    <Chart
                      options={options4}
                ...
                <tr>
                  ...
                  <td>
                    <span className="text-15 font-weight-200">White Walker</span>
                    <br />
                  </td>
                  <td>
                    <span className="badge badge-dark w-badge">Fullstack</span>
                  </td>
                  <td>
                    <Chart
                      options={options5}
        ...
        <Col sm={6} xs={12} className="mb-4">
          <Card body className="h-100">
            <Card.Title>Payment Form #01</Card.Title>
            ...
            <div className="ul-widget-list__payment-method mb-3">
              <img
                ...
                srcSet=""
              />
              <img className="mr-1" src="/assets/images/visa.png" alt="visa card" srcSet="" />
            ...
            <div className="ul-widget__payment-form">
              <form>
                ...
                <button type="button" className="btn btn-primary btn-block w-100 m-1 mb-3">
                  Confirm
                </button>
              </form>
            </div>
        ...
        <Col sm={6} xs={12} className="mb-4">
          <Card body className="h-100">
            <Card.Title>Payment Form #02</Card.Title>
            <Alert variant="danger">Some text success or error</Alert>
              ...
              <Nav variant="pills" className="px-2 d-flex">
                <Nav.Item className="flex-grow-1 text-center">
                  <Nav.Link
                    ...
                    <i className="i-Credit-Card text-16" />
                    <span className="line-height-1">Credit Card</span>
                  </Nav.Link>
                </Nav.Item>
                ...
                <Nav.Item className="flex-grow-1 text-center">
                  <Nav.Link
                    eventKey="second"
                    className="d-flex justify-content-center align-items-center gap-2">
                    <i className="i-ID-Card text-16" />
                    <span className="line-height-1">Paypal</span>
                  </Nav.Link>
                </Nav.Item>
                ...
                <Nav.Item className="flex-grow-1 text-center">
                  <Nav.Link
                    eventKey="third"
                    className="d-flex justify-content-center align-items-center gap-2">
                    <i className="i-University1 text-16" />
                    <span className="line-height-1">Bank Account</span>
                  </Nav.Link>
                </Nav.Item>
              </Nav>
                ...
                <Tab.Pane eventKey="first">
                  <div className="ul-widget__payment-form">
                    <form>
                      ...
                      <button type="button" className="btn btn-primary w-100 btn-block m-1">
                        Confirm
                      </button>
                    </form>
                  </div>
                ...
                <Tab.Pane eventKey="third">
                  <div className="ul-widget__payment-form">
                    <form>
                      ...
                      <button type="button" className="btn btn-danger btn-block m-1">
                        Confirm
                      </button>
                    </form>
                  </div>

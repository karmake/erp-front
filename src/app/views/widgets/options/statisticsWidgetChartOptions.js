...
export const bAOptions1 = {
  ...
  series: [
    { name: "income 1", data: [31, 40, 28, 51, 42, 109, 100] },
    { name: "income 2", data: [11, 32, 45, 32, 34, 52, 41] }
  ],
...
export const bAOptions2 = {
  ...
  series: [
    { name: "approve 1", data: [90, 40, 28, 51, 42, 109, 100] },
    { name: "approve 2", data: [11, 90, 45, 32, 34, 52, 41] }
  ],
...
export const bAOptions3 = {
  ...
  stroke: { curve: "smooth", width: 1 },
  series: [
    { name: "transaction 1", data: [11, 40, 28, 51, 42, 109, 100] },
    { name: "transaction 2", data: [100, 40, 45, 32, 34, 0, 41] }
  ],
...
export const bAOptions4 = {
  ...
  stroke: { curve: "straight", width: 1 },
  series: [
    { name: "sales 1", data: [31, 40, 28, 51, 42, 109, 100] },
    { name: "sales 2", data: [11, 32, 90, 32, 34, 52, 41] }
  ],
...
export const bAOptions5 = {
  ...basicAreaOption,
  stroke: { curve: "straight", width: 1 },
  series: [{ name: "approve 1", data: [31, 40, 28, 51, 42, 109, 100] }],
  colors: ["#639", "#e97d23"]
};
// end of basic area5
...
export const bAOptions6 = {
  ...basicAreaOption,
  stroke: { curve: "straight", width: 1 },
  series: [{ name: "Comments", data: [60, 20, 28, 51, 15, 40, 50] }],
  colors: ["#98dafc"]
};
// end of basic area6
...
export const bAOptions7 = {
  ...basicAreaOption,
  stroke: { curve: "straight", width: 1 },
  series: [{ name: "Contribution", data: [30, 20, 90, 2, 15, 40, 50] }],
  colors: ["#bcd5d1"]
};
...
export const bAOptions8 = {
  ...basicAreaOption,
  stroke: { curve: "straight", width: 1 },
  series: [{ name: "Watch", data: [65, 90, 10, 45, 15, 75, 50] }],
  colors: ["#6534ff"]
};
// end of basic area8
...
export const bAOptions9 = {
  ...
  series: [{ data: [12, 14, 2, 47, 42, 15, 47, 75, 65, 19, 14, 30, 50] }],
...
export const bAOptions10 = {
  chart: { height: 150, width: "60%", type: "radialBar" },
  plotOptions: {
    radialBar: {
      startAngle: -90,
      endAngle: 90,
      track: {
        ...
        shadow: { enabled: true, top: 2, left: 0, color: "#999", opacity: 1, blur: 2 }
      },
      dataLabels: {
        name: { show: false },
        value: { offsetY: 1, fontSize: "10px" }
      }
    }
  },

...
import { Row, Col, Tab, Tabs, Dropdown, ProgressBar, Table, Card, Button } from "react-bootstrap";
import Breadcrumb from "app/components/Breadcrumb";

export default function AppWidget() {
  return (
    <section>
      <Breadcrumb routeSegments={[{ name: "Widgets", path: "/widgets" }, { name: "App" }]} />

      <Row>
        <Col lg={4} md={4} sm={4} xs={12} className="mb-4">
          <Card className="h-100">
            <Card.Title className="mb-0 p-4">Projects</Card.Title>
        ...
        <Col lg={4} md={4} sm={4} xs={12} className="mb-4">
          <Card body className="h-100">
            <Card.Title>Work List</Card.Title>

            <div className="ul-widget-app__task-list mb-4">
              <label className="checkbox checkbox-primary">
                <input type="checkbox" />
                <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</span>
                <span className="badge rounded-pill bg-danger p-2 m-1 float-end">Today</span>
            ...
            <div className="ul-widget-app__task-list mb-4">
              <label className="checkbox checkbox-primary">
                <input type="checkbox" />
                <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</span>
                <span className="badge rounded-pill bg-success p-2 m-1 float-end">Tomorrow</span>
                <span className="checkmark"></span>
              </label>
              <div className="ul-widget-app__work-list-img ms-4">
                <img
            ...
            <div className="ul-widget-app__task-list mb-4">
              <label className="checkbox checkbox-primary">
                <input type="checkbox" />
                <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</span>
                <span className="badge rounded-pill bg-info p-2 m-1 float-end">yesterday</span>
                <span className="checkmark"></span>
              </label>
              <div className="ul-widget-app__work-list-img ms-4">
                <img
            ...
            <div className="ul-widget-app__task-list mb-4">
              <label className="checkbox checkbox-primary">
                <input type="checkbox" />
                <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</span>
                <span className="badge rounded-pill bg-warning p-2 m-1 float-end">Week</span>
                <span className="checkmark"></span>
              </label>
              <div className="ul-widget-app__work-list-img ms-4">
                <img
        ...
        <Col lg={4} md={4} sm={4} xs={12} className="mb-4">
          <Card body className="h-100">
            <Card.Title className="mb-1">Developer Total Earning</Card.Title>
            ...
            <div className="ul-widget-app__browser-list">
              <div className="ul-widget-app__browser-list-1 mb-4 ">
                ...
                <span className="badge bg-success rounded-pill  m-1">$5000</span>
              </div>
              ...
              <div className="ul-widget-app__browser-list-1 mb-4 ">
                ...
                <span className="badge bg-danger rounded-pill  m-1">$4000</span>
              </div>
              ...
              <div className="ul-widget-app__browser-list-1 mb-4">
                ...
                <span className="badge bg-warning rounded-pill  m-1">$2000</span>
              </div>
              ...
              <div className="ul-widget-app__browser-list-1 mb-4">
                ...
                <span className="badge bg-primary rounded-pill  m-1">$2000</span>
              </div>
            </div>
          </Card>
        </Col>
        ...
        <Col lg={4} md={4} sm={4} xs={12} className="mb-4">
          <Card body className="h-100">
            <Card.Title>Travel Different Countries</Card.Title>
            ...
            <div className="ul-widget-app__poll-list mb-4">
              ...
              <div className="d-flex mb-1">
                ...
                <span className="t-font-boldest ms-auto d-flex gap-1">
                  33%
                  <i className="i-Turn-Up-2 text-14 text-success font-weight-700" />
                </span>
              </div>

              <ProgressBar now={25} variant="info" className="progress progress--height-2 mb-3" />
            </div>
            ...
            <div className="ul-widget-app__poll-list mb-4">
              ...
              <div className="d-flex mb-1">
                ...
                <span className="t-font-boldest ms-auto d-flex gap-1">
                  63%
                  <i className="i-Turn-Down-2 text-14 text-danger font-weight-700" />
                </span>
              </div>
            ...
            <div className="ul-widget-app__poll-list mb-4">
              ...
              <ProgressBar now={33} className="progress progress--height-2 mb-3" />
            </div>
            ...
            <div className="ul-widget-app__poll-list mb-4">
              ...
              <ProgressBar now={13} variant="danger" className="progress progress--height-2 mb-3" />
            </div>
          </Card>
        </Col>
        ...
        <Col lg={4} md={4} sm={4} xs={12} className="mb-4">
          <Card className="h-100">
            <Card.Header className="purple-500 text-purple-500 p-4">
            ...
            <Card.Body>
              ...
              <div className="ul-widget-app__social-button mt-5">
                <button type="button" className="btn w-100 btn-facebook btn-icon m-1">
                ...
                <button type="button" className="btn w-100 btn-twitter btn-icon m-1">
            ...
            <div className="ul-widget-app__comments">
              <div className="ul-widget-app__row-comments">
                ...
                <div className="ul-widget-app__comment">
                  ...
                  <div className="ul-widget-app__profile-status">
                    <span className="badge rounded-pill bg-primary p-2 m-1">Pending</span>
              ...
              <div className="ul-widget-app__row-comments">
                ...
                <div className="ul-widget-app__comment">
                  ...
                  <div className="ul-widget-app__profile-status">
                    <span className="badge rounded-pill bg-success p-2 m-1">Approved</span>
                    <span className="ul-widget-app__icons">
                      <span className="cursor-pointer ps-2 pr-1 text-small">
                        <i className="i-Approved-Window text-mute"></i>
                      </span>
              ...
              <div className="ul-widget-app__row-comments">
                ...
                <div className="ul-widget-app__comment">
                  ...
                  <div className="ul-widget-app__profile-status">
                    <span className="badge rounded-pill bg-danger p-2 m-1">Rejected</span>
                    <span className="ul-widget-app__icons">
                      <span className="cursor-pointer ps-2 pr-1 text-small">
                        <i className="i-Approved-Window text-mute"></i>
                      </span>
        ...
        <Col lg={4} md={4} sm={4} xs={12} className="mb-4">
          <Card body>
            <Card.Title className="mb-0">Order</Card.Title>
            <Card.Text>Buy & Sell Crypto Currency</Card.Text>
            ...
            <Tabs defaultActiveKey="home">
              <Tab title="Home" eventKey="home">
                <div className="ul-widget-app__buy-currency">
                  ...
                  <button type="button" className="btn bg-primary text-white btn-icon m-1">
                    Buy Coin
                  </button>
                </div>
              </Tab>
              ...
              <div className="ul-widget-app__profile-footer mt-4">
                ...
                <div className="ul-widget-app__profile-footer-font">
                  <Link to="/pages/user-profile">
                    ...
                    <span className=" text-16 font-weight-600">Portfolio</span>
                  </Link>
                </div>
              </div>
            </div>
        ...
        <Col lg={4} md={4} sm={4} xs={12} className="mb-4">
          <Card body>
            <Card.Title className="mb-0">Feedback</Card.Title>
            <Card.Text>Checking the feedback</Card.Text>
        ...
        <Col lg={4} md={4} sm={4} xs={12} className="mb-4">
          <Card body className="h-100">
            ...
            <div className="ul-widget-app__header mb-4">
              ...
              <h6 className="text-mute font-weight-600">Your mobile app daily usage</h6>
            </div>
            ...
            <label className="radio radio-primary">
              ...
              <span className="font-weight-700">B More than 30 minutes</span>
              <span className="checkmark" />
            </label>
        ...
        <Col lg={4} md={4} sm={4} xs={12} className="mb-4">
          <Card body className="h-100">
            <Card.Title>Browser Status</Card.Title>

            <div className="ul-widget-app__browser-list">
              <div className="ul-widget-app__browser-list-1 mb-4">
                <i className="i-Chrome text-18 text-danger font-weight-600 me-3" />
                <span className="text-15">Google Chrome</span>
                <span className="badge bg-success rounded-pill m-1">99%</span>
              </div>

              <div className="ul-widget-app__browser-list-1 mb-4">
                <i className="i-Firefox text-18 text-warning font-weight-600 me-3" />
                <span className="text-15">Firefox</span>
                <span className="badge bg-danger rounded-pill m-1">89%</span>
              </div>

              <div className="ul-widget-app__browser-list-1 mb-4">
                <i className="i-Internet-Explorer text-18 text-info font-weight-600 me-3" />
                <span className="text-15">Internet Explorer</span>
                <span className="badge bg-primary rounded-pill m-1">9%</span>
              </div>

              <div className="ul-widget-app__browser-list-1 mb-4">
                <i className="i-Opera text-18 text-danger font-weight-600 me-3" />
                <span className="text-15">Opera Mini</span>
                <span className="badge bg-dark rounded-pill m-1">9%</span>
              </div>

              <div className="ul-widget-app__browser-list-1 mb-4">
                <i className="i-Android text-18 text-success me-3" />
        ...
        <Col lg={4} md={4} sm={4} xs={12} className="mb-4">
          <Card body className="h-100">
            ...
            <div className="ul-widget-app__poll-list mb-4">
              ...
              <ProgressBar now={25} variant="danger" className="progress--height-2" />
            </div>
            ...
            <div className="ul-widget-app__poll-list mb-4">
              ...
              <ProgressBar now={55} variant="success" className="progress--height-2" />
            </div>
            ...
            <div className="ul-widget-app__poll-list mb-4">
              ...
              <ProgressBar now={25} variant="warning" className="progress--height-2" />
            </div>
            ...
            <div className="ul-widget-app__poll-list mb-4">
              ...
              <ProgressBar now={13} variant="info" className="progress--height-2" />
            </div>
          </Card>
        </Col>
        ...
        <Col sm={4} xs={12} className="mb-4">
          <Card body>
            ...
            <div className="input-group mb-3">
              ...
              />
              <Dropdown>
                <Dropdown.Toggle className="toggle-hidden">Unit</Dropdown.Toggle>
                <Dropdown.Menu>
            ...
            <div className="timeline timeline--align">
              <div className="timeline-item mt-0">
                <div className="timeline-badge fs-1">
                  <i className="bg-icon bg-danger p-2 rounded-pill text-white i-Repeat-3" />
                </div>
              </div>
            </div>
            ...
            <Button className="btn-lg m-1">Trading Now</Button>
          </Card>
        </Col>
      </Row>
    </section>

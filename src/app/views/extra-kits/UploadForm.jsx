...
export default function UploadForm() {
  ...
  const handleFileSelect = (event) => {
    ...
    setState((prevState) => ({ ...prevState, files: [...list] }));
  };
  ...
  const handleDrop = (event) => {
    ...
    setState((prevState) => ({ ...prevState, dragClass: "", files: [...list] }));
  ...
  const handleAllRemove = () => {
    setState((prevState) => ({ ...prevState, files: [], queProgress: 0 }));
  };
  ...
  const uploadSingleFile = (index) => {
    ...
    setState((prevState) => ({ ...prevState, files: [...allFiles] }));
  };
  ...
  const uploadAllFile = () => {
    ...
    setState((prevState) => ({ ...prevState, files: [...allFiles], queProgress: 35 }));
  };
  ...
  const handleCancelAll = () => {
    ...
    setState((prevState) => ({ ...prevState, files: [...allFiles], queProgress: 0 }));
  };
    ...
    <div>
      ...
      <Card body>
            ...
            return (
              <Row className="align-items-center px-3" key={file.name}>
                ...
                <Col lg={2} md={2} sm={12} xs={12} className="mb-3">
                  <ProgressBar now={progress} variant="success" className="progress-thin" />
                </Col>

                <Col lg={1} md={1} sm={12} xs={12} className="mb-3">
                  {error && <i className="i-Information text-danger text-18" />}
                </Col>

                <Col lg={4} md={4} sm={12} xs={12} className="mb-3">
                  <div className="d-flex">
                    <Button disabled={uploading} onClick={() => uploadSingleFile(index)}>
                      Upload
                    </Button>
                    ...
                    <Button variant="danger" onClick={() => handleSingleRemove(index)}>
                      Remove
                    </Button>
                  </div>
                </Col>
        ...
        <div>
          ...
          <div className="py-3">
            <ProgressBar now={queProgress} variant="success" className="progress-thin" />
          </div>
          ...
          <div className="flex">
            ...
            <Button className="mx-8" variant="warning" disabled={isEmpty} onClick={handleCancelAll}>
              Cancel All
            </Button>
